...
"#,
    ...
    tags(
        ...
        (name = "skills", description = "Manage Agent Skills (https://agentskills.io). A skill packages a SKILL.md instruction file plus optional bundled scripts, references, and assets. Skills can be user-invoked via slash command or auto-invoked by the model via the frontend Skill tool."),
    ...
    paths(
        ...
        admin::skills::update,
        admin::skills::delete,
        admin::skills::list_by_org,
        admin::skills::list_by_team,
        admin::skills::list_by_project,
        admin::skills::list_by_user,
    ...
    components(schemas(
        ...
        admin::skills::SkillListResponse,
        // Admin routes - DLQ
